# -*- coding: utf-8 -*-
"""q2_dependency_parser.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GwLzIvTmfb0lWGGIoqN7yJi9_vp5p4M-
"""

"""Question 2: transition-based dependency parser.

This module implements a data-driven dependency parser using the
arc-standard transition system. It parses CoNLL-U data, generates
training examples using an oracle, extracts the required POS-based
features, and trains a machine-learning classifier to predict parser
transitions.

The module also evaluates the trained parser using Labeled Attachment
Score (LAS) and demonstrates parsing on the required example sentences.
"""
